...
async function GSCreate(projectName) {
    ...
    const execRes = (0, child_process_1.execSync)(`chmod 0600 ${devcontainerDir}/scripts/mongo-keyfile`);
...
*/
function GSClean() {
    (0, child_process_1.exec)(`npm run clean`, (error, stdout, stderr) => {
        if (error) {
...
async function main() {
    ...
    commander_1.default.command('dev').action(() => {
        GSDev();
    });
    commander_1.default.command('create <projectName>').action((projectName) => {
