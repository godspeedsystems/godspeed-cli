...
=======
    ...
    try {
        ...
        fs_1.default.writeFileSync(mongodbRsInitPath.replace('.ejs', ''), mongodbRsInitPathTemplate({ projectName, mongoDbName }));
...
>>>>>>> adding version, versions, prepare commands and cleanup
}
/************************************************/
async function main() {
    ...
    commander_1.default
        .command('prisma')
        .allowUnknownOption();
    commander_1.default.command('versions', 'List all the available versions of gs_service').action(() => {
        axios_1.default
