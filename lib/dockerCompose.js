...
function createDockerCompose(projectName, devcontainerDir) {
    ...
    const incMongo = (0, utils_1.ask)('Do you need mongodb? [y/n] ');
    if (incMongo) {
        const mongoDbName = (0, utils_1.prompt)('Please enter name of the mongo database [default: test] ') || 'test';
    ...
    if (incPostgres) {
        const postgresDbName = (0, utils_1.prompt)('Please enter name of the mongo database [default: test] ') || 'test';
